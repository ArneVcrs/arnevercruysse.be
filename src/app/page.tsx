export default function Home() {
  return (
    <>
      ...
      <p>
        This site is my personal little corner of the internet: a place where I can share my thoughts on my blog, 
        showcase my portfolio, and expirement with new ideas. It&apos;s a work in progress, I will be adding more content as I find the time.
      </p>
